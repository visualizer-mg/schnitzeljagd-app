...
const PLAYER_PUZZLES = {
  ...
  ellen: [
    ...
    { id: 'ellen-2', label: 'Rätseltruhe 2', solvedLabel: 'Kreuzworträtsel', chained: true, password: 'geburtstag', taunt: 'Ellen, das Lösungswort des Kreuzworträtsels ist dein Passwort!', game: 'birthday-clue', matrixClue: 'D1: 4 - 9 - 3 - 1' },
  ],
  theresa: [
